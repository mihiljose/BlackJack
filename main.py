...
#Hint: Go to this website and try out the Blackjack game: 
...
def compare(user_score,computer_score):
  if user_score == computer_score:
    ...
    return "You Lost!🖥 has a BlackJack🙀"
  elif user_score == 0:
    return "BlackJack! You Win♠️♥️♣️♦️"
  elif user_score > 21:
...
while input("Do you want to play a game of Blackjack♠️♥️♣️♦️? Type 'y' or 'n': ") == "y":
  clear()
  play_game()
